                  ...
                  <td style="padding:0 32px 8px;">
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border:1px solid #e4e7eb;border-radius:6px;">
                      ...
                      <tr>
                        ...
                        <td style="padding:14px 20px;border-bottom:1px solid #eef0f2;font-size:14px;color:#1a1a1a;">1:30 PM &ndash; 3:00 PM</td>
                      </tr>
                      <tr>
                        <td style="padding:14px 20px;font-size:13px;color:#6b7280;font-weight:600;">Venue</td>
                        <td style="padding:14px 20px;font-size:14px;color:#1a1a1a;">JC Bose Auditorium, Civil Block</td>
                      </tr>
                    </table>
                  </td>
                </tr>
