...
const AarambhModal = () => {
  ...
  const [width, setWidth] = useState('90%'); // Default value for SSR
  ...
  return (
      <Modal open={open} onClose={onCloseModal} center styles={{modal: {width: width,backgroundColor:'transparent'}}}>
