...
function navbar() {
  return (
    <header className="">
      <div className="w-full h-fit bg-[#0A146E] grid grid-cols-1 lg:grid-cols-2 px-8 py-2 text-white font-semibold max-sm:flex-col py-4">
        <div className="flex justify-between items-center ease-in-out">
          <div><Link href="/"><Image src={sntLogo} alt="S&T Logo" className="w-auto h-12" /></Link></div>
          <Hamburger/>
        </div>
